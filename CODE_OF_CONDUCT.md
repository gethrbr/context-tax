...
maintainers by opening a [private report](https://github.com/gethrbr/context-tax/security/advisories/new),
which is visible only to them, or by contacting [@shoustak](https://github.com/shoustak) directly on
GitHub. All complaints will be reviewed and investigated promptly and fairly, and the privacy and
...
2. **Warning.** A warning with consequences for continued behavior, including no interaction with
   those involved for a specified period of time.
